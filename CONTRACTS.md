...
export interface ModelTelemetry { provider, model, tier, task, inputTokens, outputTokens, latencyMs, costUsd, truncated: boolean }
...
export class ModelGateway { constructor(providers: ModelProvider[], opts?: { routing?: Partial<Record<ModelTier, string>>; budgetUsdCap?: number; onTelemetry?: (t: ModelTelemetry & { rejectedInjection?: boolean }) => void }); complete(req): Promise<ModelResponse>; }
```
