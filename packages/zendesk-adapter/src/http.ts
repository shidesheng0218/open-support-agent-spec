/**
 * Minimal injectable HTTP seam (v0.1.1 Milestone 3). Adapters never call
 * fetch directly — tests inject a mock client, production uses the default
 * fetch-based one. Credentials live in headers set by the adapter and are
